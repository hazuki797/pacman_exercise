...
// Get a random index from the pacArray
const randomIndex = Math.floor(Math.random() * pacArray.length);
// Get a random image from the pacArray using the random index
const randomImage = pacArray[randomIndex][Math.floor(Math.random() * 2)];
